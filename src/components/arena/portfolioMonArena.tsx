...
const PhaseRail = ({ phase }: { phase: ArenaPhase }) => {
  ...
  return (
    <div className="hidden items-center xl:flex" aria-label="Match progress">
    ...
    {[0, 1, 2].map((slot) => {
      ...
      return (
        <motion.div
          key={slot}
          layout
          className="arena-card arena-panel relative aspect-video overflow-hidden border bg-white/[0.035]"
          style={{
          ...
          {mon ? (
            ...
            >
              <ArenaImage
                ...
                sizes="180px"
                fit="contain"
                accent={TYPE_COLORS[mon.type1] ?? "#d8ff36"}
                className="absolute inset-0"
              />
              ...
              <button
                ...
                className="absolute right-1.5 top-1.5 flex h-8 w-8 items-center justify-center border border-white/[0.20] bg-black/[0.75] text-white transition hover:border-red-300 hover:bg-red-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#d8ff36]"
              >
                <X className="h-3 w-3" />
              </button>
            </motion.div>
...
const TrainerSelector = ({
  ...
  return (
    <div
      className={`arena-card relative grid min-w-0 grid-cols-[32px_52px_minmax(0,1fr)_32px] items-center gap-2 overflow-hidden border bg-[#080b10]/[0.96] p-2 ${
        reversed ? "text-right" : ""
      }`}
      style={{
    ...
    >
      ...
      <div className="relative h-14 overflow-hidden border border-white/[0.12] bg-white/[0.035]">
        <TrainerSprite
          trainer={value}
          mode={mode}
      ...
      >
        ...
        <span className="block truncate pr-1 font-nacelle text-[8px] text-white/[0.42]">
...
const TrainerArchiveModal = ({
  ...
  return createPortal(
    ...
    >
      ...
      >
        <ArenaFrameArt accent="#d8ff36" animated density="full" />
        ...
        <footer className="relative z-[70] flex flex-col justify-between gap-2 border-t border-white/[0.10] bg-[#080b10] px-4 py-3 font-nacelle text-[9px] text-white/[0.38] sm:flex-row sm:items-center sm:px-6">
          <span>
      ...
      >
        ...
        <div className="mt-4 grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
          {[
            [
              "01 / Draft + trainers",
              "Click any project card to add it, and click a selected card again to remove it. Lock three, then browse all 258 Generation V source sprites for both trainer slots. Trainers are visual identities; your projects determine the stats.",
            ],
            [
              "02 / Turn order",
            ...
            [
              "10 / Project battle rigs",
              "Every PortfolioMon compiles into one of six stable pixel-HD bodies: biped, quadruped, arachnid, winged, serpent, or mech. Limbs articulate on commands, cores morph on impact, and attacks travel from the acting rig to the actual target.",
            ],
...
const FocusedFighterPanel = ({
  ...
  return (
    ...
    >
      <div className="relative min-h-[250px] flex-[0.95] overflow-hidden sm:min-h-[280px]">
        <ArenaImage
          src={mon.image}
      ...
      <div className="grid min-w-0 flex-1 gap-6 border-t border-white/[0.12] bg-[#0a0d12] p-5 sm:grid-cols-[0.68fr_1.32fr] sm:p-6">
            ...
            {mon.moves.map((move, index) => {
              ...
              return (
                <motion.div
                  ...
                  className="arena-card group relative min-h-[128px] min-w-0 overflow-hidden border p-3.5"
                  style={{
                ...
                >
                  ...
                  <div className="relative z-10 flex items-start gap-2.5">
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <p className="line-clamp-2 min-h-[30px] font-telegraf text-[11px] font-black leading-[1.08] text-white">
                        {move.name}
                      </p>
                    </div>
                  </div>
                  <p className="relative z-10 mt-2 line-clamp-2 min-h-[25px] font-nacelle text-[9px] leading-snug text-white/[0.54]">
                    {move.description}
                  </p>
                  <div className="relative z-10 mt-2.5 grid grid-cols-3 gap-1.5 border-t border-white/[0.09] pt-2">
                    {[
                      ["PWR", move.power ?? "—"],
                      ...
                      <span
                        key={label}
                        className="min-w-0 bg-black/[0.28] px-1.5 py-1"
                      >
                        <span className="block font-kode text-[5px] uppercase tracking-[0.11em] text-white/[0.30]">
                          {label}
                        </span>
                        <strong
                          className="block whitespace-nowrap font-kode text-[6px] uppercase tracking-[0.03em] text-white/[0.72]"
                          style={
                            label === "Rule" ? { color: moveColor } : undefined
                          }
                        >
                          {value}
                        </strong>
  ...
  return (
    <>
      <motion.div
        ...
        className="relative z-10 flex min-h-[calc(100svh-68px)] flex-col px-3 py-5 sm:min-h-[calc(100svh-5rem)] sm:px-6 sm:py-7"
      >
        <div className="mx-auto mb-7 flex w-full max-w-[1600px] items-end justify-between gap-7 px-1">
          ...
          <div className="hidden w-[600px] grid-cols-2 gap-4 lg:grid">
            <TrainerSelector
              label="Your trainer"
              value={playerTrainer}
              mode={trainerMode}
        ...
        <div className="mx-auto mb-6 grid w-full max-w-[1600px] gap-3 sm:grid-cols-2 lg:hidden">
          <TrainerSelector
            label="Your trainer"
            value={playerTrainer}
            mode={trainerMode}
        ...
        <div className="mx-auto grid min-h-0 w-full max-w-[1600px] flex-1 items-stretch gap-5 lg:h-[clamp(760px,calc(100svh-200px),880px)] lg:flex-none lg:grid-cols-[minmax(420px,0.92fr)_minmax(0,1.58fr)]">
          <div
            className="arena-cut-outline arena-panel relative order-2 min-h-[620px] min-w-0 overflow-hidden border bg-[#090c12] lg:order-1 lg:min-h-0"
            style={{
          ...
          <div className="order-1 flex min-h-0 min-w-0 flex-col gap-5 lg:order-2">
            <div
              className="scrollbar relative h-[min(68svh,620px)] min-h-[440px] flex-none overflow-y-auto border border-white/[0.18] bg-[#07090d]/[0.98] p-3 pb-8 sm:min-h-[480px] sm:p-5 sm:pb-9 lg:h-auto lg:min-h-0 lg:flex-1"
              style={{
                ["--arena-stroke" as string]: "rgba(255,255,255,.28)",
                clipPath: ARENA_CLIP,
              }}
            >
              <ArenaFrameArt accent="#d8ff36" density="full" />
              <div className="sticky top-0 z-20 mb-5 space-y-3.5 border-b border-white/[0.12] bg-[#07090d]/[0.97] px-1 pb-4 pt-1 backdrop-blur-md">
                <div className="flex items-center justify-between gap-3">
                  <div className="flex items-center gap-2">
                    <MousePointerClick className="h-3.5 w-3.5 text-[#d8ff36]" />
                    <div>
                      <span className="block font-kode text-[7px] uppercase tracking-[0.18em] text-white/[0.68]">
                        {selected.length === 3
                          ? "Team compiled / ready"
                          : "Click a project to add it"}
                      </span>
                      <span className="mt-0.5 hidden font-nacelle text-[9px] text-white/[0.34] sm:block">
                        {selected.length === 3
                          ? "Launch now, or click a selected card to make room for another build."
                          : "Click it again to remove it. Hover or focus previews the build."}
                      </span>
                    </div>
                  </div>
                  <div aria-live="polite" className="shrink-0">
                    {selected.length === 3 ? (
                      <motion.button
                        ...
                        className="arena-interactive flex h-9 items-center gap-2 border border-[#d8ff36] bg-[#d8ff36] px-3 font-kode text-[7px] font-bold uppercase tracking-[0.13em] text-black hover:bg-white"
                      >
                        <Swords className="h-3.5 w-3.5" /> Launch
                      </motion.button>
                    ) : (
                      <div
                        className="flex items-center gap-2"
                        aria-label={`${selected.length} of 3 team slots selected`}
                      >
                        <div className="flex gap-1" aria-hidden="true">
                          {[0, 1, 2].map((slot) => (
                            <motion.span
                              key={slot}
                              className={`h-2 w-4 border ${
                        ...
                        <span className="font-kode text-[7px] uppercase tracking-[0.12em] text-white/[0.45]">
                          {selected.length}/3
                        </span>
                      </div>
                    )}
                ...
                <div className="scrollbar flex gap-1 overflow-x-auto pb-0.5">
                  {PROJECT_TYPES.map((type) => (
                    <button
                      ...
                      className={`h-8 shrink-0 border px-2.5 font-kode text-[6px] uppercase tracking-[0.12em] transition ${
                        activeType === type
                          ? "border-white bg-white text-black"
                  ...
                  {filteredMons.map((mon) => {
                    ...
                    return (
                      <motion.button
                        ...
                        aria-label={
                          isSelected
                            ? `Remove ${mon.name} from team`
                            : teamIsFull
                            ? `Inspect ${mon.name}; team is full`
                            : `Add ${mon.name} to team`
                        }
                        whileHover={{ y: -3, scale: 1.015 }}
                        whileTap={{ scale: 0.96 }}
                        className={`arena-interactive group relative aspect-[16/10] overflow-hidden border bg-black text-left ${
                          teamIsFull && !isSelected ? "saturate-[0.72]" : ""
                        }`}
                        style={{
                          ["--arena-stroke" as string]:
                      ...
                      >
                        <ArenaImage
                          src={mon.image}
                          alt={mon.name}
                          sizes="(min-width: 1280px) 130px, (min-width: 1024px) 150px, 45vw"
                          fit="contain"
                          accent={typeColor}
                          className="absolute inset-0"
                        />
                        ...
                        />
                        <div className="absolute inset-x-0 bottom-0 flex items-end justify-between gap-1.5 bg-gradient-to-t from-black via-black/[0.92] to-transparent px-2 pb-2 pt-5">
                          <span className="min-w-0 truncate font-telegraf text-[11px] font-black text-white sm:text-xs">
                            {mon.name}
                          </span>
                          <span
                            className="shrink-0 font-kode text-[5px] uppercase tracking-[0.08em]"
                        ...
                        <motion.span
                          ...
                          animate={
                            isSelected ? { scale: [0, 1.2, 1] } : { scale: 1 }
                          }
                          className={`absolute right-1 top-1 flex h-6 min-w-6 items-center justify-center gap-1 border px-1.5 font-kode text-[6px] font-bold uppercase tracking-[0.08em] ${
                            isSelected
                              ? "border-white bg-white text-black"
                              : teamIsFull
                              ? "border-white/[0.20] bg-black/[0.84] text-white/[0.38]"
                              : "border-white/[0.26] bg-black/[0.84] text-white"
                          }`}
                          style={
                            isSelected
                              ? { boxShadow: `0 0 16px ${typeColor}` }
                              : undefined
                          }
                        >
                          {isSelected ? (
            ...
            <div
              className="relative z-20 grid min-h-[156px] gap-5 overflow-hidden border border-white/[0.18] bg-[#090c12] p-5 sm:grid-cols-[1fr_auto] sm:p-6 lg:p-5"
              style={{
                ...
                <div className="mb-2 flex items-center justify-between px-0.5">
                  ...
                  <span className="hidden font-kode text-[6px] uppercase tracking-[0.12em] text-white/[0.30] md:block">
                    {selected.length
                      ...
                      : "Click any project card to begin"}
                  </span>
                </div>
        ...
        <div className="relative grid items-stretch gap-4 lg:grid-cols-[1fr_176px_1fr] lg:gap-5">
          {sides.map((config, sideIndex) => {
            ...
            return (
              ...
              >
                <ArenaFrameArt accent={config.accent} animated density="full" />
                <div
...
const MoveButton = ({
  ...
  return (
    <motion.button
      ...
      className="arena-card group relative min-h-[150px] overflow-hidden border p-3.5 text-left text-white disabled:cursor-not-allowed disabled:opacity-25"
      style={{
    ...
    >
      ...
      <div className="relative z-10 flex items-start gap-3">
        <MoveGlyph
          type={move.type}
          accent={color}
          className="h-11 w-11 shrink-0 transition-transform duration-300 group-hover:-rotate-3 group-hover:scale-105"
        />
        <div className="min-w-0 flex-1">
          <span
          ...
          <p className="mt-0.5 line-clamp-2 min-h-[38px] font-telegraf text-sm font-black leading-[1.05] tracking-[-0.01em] sm:text-base">
            {move.name}
          </p>
        </div>
        <div className="shrink-0 border border-white/[0.10] bg-black/[0.25] px-2 py-1.5 text-right">
          <span className="block font-kode text-[8px] text-white/[0.65]">
      ...
      <p className="relative z-10 mt-2 line-clamp-2 min-h-[25px] font-nacelle text-[9px] leading-snug text-white/[0.44]">
        {move.description}
      </p>
      <div className="relative z-10 mt-3 grid grid-cols-3 gap-1.5 border-t border-white/[0.09] pt-2.5">
        <span className="bg-black/[0.28] px-2 py-1.5">
          <span className="block font-kode text-[5px] uppercase tracking-[0.11em] text-white/[0.28]">
            Power / aim
          </span>
          <strong className="mt-0.5 flex items-center gap-1 font-kode text-[7px] uppercase tracking-[0.05em] text-white/[0.75]">
            {move.power ?? "UTIL"} · <Target className="h-2.5 w-2.5" />
            {Math.round(move.accuracy * 100)}%
          </strong>
        </span>
        <span
          className="min-w-0 bg-black/[0.28] px-2 py-1.5"
        ...
        >
          ...
          <strong
            className="mt-0.5 block truncate font-kode text-[7px] uppercase tracking-[0.05em]"
            style={{ color }}
          >
            {specialRules[0] ?? "direct"}
          </strong>
        </span>
        <span className="bg-black/[0.28] px-2 py-1.5 text-right">
          <span className="block font-kode text-[5px] uppercase tracking-[0.11em] text-white/[0.28]">
            Matchup
          </span>
          <strong
            className={`mt-0.5 block font-kode text-[7px] uppercase tracking-[0.05em] ${
              effectiveness > 1
                ? "text-[#d8ff36]"
                : effectiveness < 1
                ? "text-orange-300"
...
const BattlePlatform = ({ color }: { color: string }) => (
  <div className="pointer-events-none absolute -bottom-[24%] left-[-2%] aspect-[2/1] w-[104%]">
    <svg
      aria-hidden="true"
      viewBox="0 0 520 260"
    ...
    >
      ...
      />
      <path
        d="M48 24 472 236M472 24 48 236"
        stroke={color}
        strokeOpacity=".24"
      ...
      />
      <path
        d="M260 80 360 130 260 180 160 130Z"
        fill="none"
        stroke={color}
        strokeOpacity=".34"
        vectorEffect="non-scaling-stroke"
    ...
    <IsometricBattleInsignia
      accent={color}
      className="absolute left-1/2 top-1/2 h-[48%] w-[42%] -translate-x-1/2 -translate-y-1/2"
    />
    <div
      className="absolute inset-x-[12%] bottom-[8%] h-[48%] rounded-[50%] blur-xl"
...
const BattleScreen = ({
  ...
  const [effectAnchors, setEffectAnchors] = useState(BATTLE_EFFECT_DEFAULTS);
  const battlefieldRef = useRef<HTMLElement>(null);
  const playerRigRef = useRef<HTMLDivElement>(null);
  const cpuRigRef = useRef<HTMLDivElement>(null);
  ...
  useEffect(() => {
    const measureAnchors = () => {
      const battlefield = battlefieldRef.current?.getBoundingClientRect();
      const playerRig = playerRigRef.current?.getBoundingClientRect();
      const cpuRig = cpuRigRef.current?.getBoundingClientRect();
      if (!battlefield || !playerRig || !cpuRig) return;
      ...
      const toStagePoint = (rect: DOMRect) => ({
        x: Math.max(
          ...
          Math.min(
            96,
            ((rect.left - battlefield.left + rect.width * 0.5) /
              battlefield.width) *
              100
          )
        ),
        y: Math.max(
          ...
          Math.min(
            94,
            ((rect.top - battlefield.top + rect.height * 0.48) /
              battlefield.height) *
              100
          )
        ),
      ...
      setEffectAnchors({
        player: toStagePoint(playerRig),
        cpu: toStagePoint(cpuRig),
      });
    };
    ...
    if (playerRigRef.current) observer.observe(playerRigRef.current);
    if (cpuRigRef.current) observer.observe(cpuRigRef.current);
  ...
  }, [cpuFighter.mon.id, playerFighter.mon.id]);
  ...
  return (
    ...
    >
      <div className="relative mx-auto grid min-h-[calc(100svh-68px)] max-w-[1600px] grid-rows-[minmax(490px,1fr)_auto] gap-4 p-3 sm:min-h-[calc(100svh-5rem)] sm:p-4 lg:grid-rows-[minmax(460px,1fr)_auto]">
        <motion.section
          ref={battlefieldRef}
          data-testid="battlefield"
          aria-label="PortfolioMon battlefield"
        ...
        >
          <ArenaFrameArt accent={playerColor} animated density="full" />
          <ArenaImage
          ...
          />
          <motion.div
            className="absolute left-1/2 top-1/2 h-32 w-56 -translate-x-1/2 -translate-y-1/2 opacity-35 sm:h-40 sm:w-72"
            animate={{ y: [0, -3, 0], opacity: [0.24, 0.42, 0.24] }}
            transition={{
          ...
          <div
            className="arena-cut-outline arena-panel absolute right-3 top-12 z-40 w-[90%] max-w-sm border bg-[#0b0d11]/[0.97] p-3 shadow-2xl sm:right-5 sm:top-5 sm:w-[68%]"
            style={{
          ...
          <div
            className="arena-cut-outline arena-panel absolute bottom-3 left-3 z-40 w-[90%] max-w-sm border bg-[#0b0d11]/[0.97] p-3 shadow-2xl sm:bottom-5 sm:left-5 sm:w-[70%]"
            style={{
              ["--arena-accent" as string]: playerColor,
          ...
          <div
            ref={cpuRigRef}
            className="absolute right-0 top-[33%] z-20 w-[48%] max-w-[450px] sm:right-[3%] sm:w-[42%] lg:right-[6%] lg:top-[27%] lg:w-[36%]"
          >
          ...
          <div
            ref={playerRigRef}
            className="absolute bottom-[19%] left-0 z-20 w-[52%] max-w-[520px] sm:bottom-[13%] sm:left-[3%] sm:w-[46%] lg:left-[7%] lg:w-[38%]"
          >
          ...
          <MoveEffectLayer event={visual} anchors={effectAnchors} />
        </motion.section>
        ...
        >
          <ArenaFrameArt accent={playerColor} animated={busy} density="full" />
  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-[#07090d] font-nacelle">
      ...
      {typeof document !== "undefined" &&
        createPortal(<BattleNoticeStack notices={notices} />, document.body)}
      <AnimatePresence>
