...
- At General Translation since July 2026. Previously a Founding Engineer at Dedalus Labs (YC S25), where I built production agent infrastructure: an MCP-powered SDK, multi-tenant auth (DAuth), and sandboxed execution via microVM workspaces and container orchestration.
